Config = {
    ...
    LicensePlate = "TECNICO", -- Make "" for random text
    ...
    TranslationList = { -- List of all translation which you car choose
        ["EN"] = {
            ["LOCKER_HELP"] = "Presione ~INPUT_CONTEXT~ para abrir el casillero!",
            ["LOCKER_MENU"] = "Menú de casilleros",
            ["WORK_CLOTHES"] = "Ropa de trabajo",
            ["NORMAL_CLOTHES"] = "Ropa normal",

            ["GARAGE_HELP"] = "Presione ~INPUT_CONTEXT~ para abrir el garaje!",
            ["GARAGE_MENU"] = "Menú del garaje",
            ["GARAGE_PROBLEM"] = "~r~ Algo salió mal al generar el vehículo. (¡Detenido para evitar choques!)",
            
            ["DELETE_HELP"] = "Presione ~INPUT_CONTEXT~ para borrar su vehículo!",

            ["MENU_HELP"] = "Presione ~INPUT_SELECT_CHARACTER_FRANKLIN~ para abrir tu menú!",
            ["MENU_MENU"] = "Menu",
            ["MENU_NEW"] = "Consiga un nuevo trabajo",
            ["MENU_CREATED"] = "~g~ Creó con éxito un nuevo trabajo!",
            ["MENU_CANCEL"] = "Cancel trabajo actual",
            ["MENU_CANCELED"] = "~g~ Canceló exitosamente su trabajo!",
            ["MENU_ALREADY"] = "~r~ Ya estás haciendo un trabajo! Primero necesitas cancelarlo.",
            ["MENU_NONE"] = "~r~ No tienes trabajo activo!",

            ["JOB_HELP"] = "Presione ~INPUT_CONTEXT~ echar un vistazo!",
            ["JOB_DONE"] = "~g~ Se solucionó el problema con éxito. Usted ha ganado ~b~$100,-~g~ para ello!"
        },
        ["NL"] = {
